<div class="relative group">
    <div class="relative p-3 z-10 w-full h-full rounded-3xl border-2 border-black p-1 bg-white transition-transform duration-200 ease-in-out transform group-hover:translate-x-2 group-hover:-translate-y-2">
        <div class="rounded-2xl p-2 bg-[#EAFCC9] text-center">Free Course</div>
        <div class="text-center pt-4 pb-4">
            <h1 class="text-center pb-2 text-2xl font-semibold ">Learn HTML</h1>
            <div class="w-64">Start at the beginning by learning HTML basics - an important foundation for building and editing web pages.</div>
        </div>
        <div class="rounded-2xl p-2 bg-[#EAFCC9] flex justify-between">
            <div>Beginner Friendly</div>
            <div class="text-gray-500">7 Lessons</div>
        </div>
    </div>
